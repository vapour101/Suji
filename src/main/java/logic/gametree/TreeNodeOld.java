...
public class TreeNodeOld {
	...
	private Vector<TreeNodeOld> children;
	private TreeNodeOld parent;
	...
	public Vector<TreeNodeOld> getChildren() {
		return children;
	}

	public void addChild(TreeNodeOld child) {
	...
	public TreeNodeOld getParent() {
		return parent;
	}

	public void setParent(TreeNodeOld parent) {
		if ( this.parent != null ) {
	...
	public void removeChild(TreeNodeOld child) {
